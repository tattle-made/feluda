...
def default_db_doc(doc_id=None, has_image=False, has_text=False, date_added=datetime.now(), date_updated=datetime.now(), tags=[], text=None, lang=None, text_vec=None, image_vec=None, doc_vec=None):
    if doc_id == None:
