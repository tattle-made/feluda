...
from dtypes.video import make_from_file
...
class Test(unittest.TestCase):
    ...
    def test_sample_video_from_disk(self):
        video = make_from_file("sample_data/cat_water.mp4")
    ...
    def test_unsupported_sample_video_from_disk(self):
        video = make_from_file("sample_data/cat_vid_94mb.mp4")
    ...
    def test_sample_video_from_url(self):
        ...
        video = make_from_file(video_path)
