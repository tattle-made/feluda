...
def indexer(feluda):
    def worker(ch, method, properties, body):
        ...
        try:
            ...
            log.info(hash)
            pg_manager.store("user_message_inbox_duplicate", "value", hash, "worker_name", "blake2b_hash_value")
...
try:
    ...
    pg_manager.create_table("user_message_inbox_duplicate", "value", "worker_name")
